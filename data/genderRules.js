const PRODUCT_FILTER_RULES = {
  ...
  Enfant: [
    ...
    "alcool", "adultes","makeup", "make up","lifting","paupières","épilateur","vernis", "masque", "beauté","maquillage", "rouge à lèvres", "musculation", "fitness","Maquillage", "Rasoir", "Anti age","capillaires", "perfume","anti ride"
  ]
};
